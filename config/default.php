...
return [
    ...
    |
     */
    'templates_path' => 'resources/postgrenerator/templates',
    ...
    |--------------------------------------------------------------------------
    |
    | You can use Laravel Storage filesystem. By default, the postgrenerator
    ...
    |
     */
    'resource_file_path' => 'resources/postgrenerator/sources',
    ...
    |
     */
    'system_files_path' => 'resources/postgrenerator/system',
    ...
    | yet generated or generated using laravel-postgrenerator.
    |
    ...
    |--------------------------------------------------------------------------
    |
    | To make constructing fields easy, the postgrenerator scans the field's name
    ...
    |--------------------------------------------------------------------------
    |
    | The postgrenerator heavily uses Laravel helpers "str_plural()"
