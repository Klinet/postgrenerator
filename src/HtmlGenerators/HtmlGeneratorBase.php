...
namespace Akali\Postgrenerator\HtmlGenerators;

use Akali\Postgrenerator\Models\Field;
use Akali\Postgrenerator\Models\Label;
use Akali\Postgrenerator\Support\ValidationParser;
...
abstract class HtmlGeneratorBase
{
     ...
     *
     * @var Akali\Postgrenerator\Support\ViewLabelsGenerator
     */
     ...
     *
     * @param string $name
     * @param Akali\Postgrenerator\Models\Label $label
     *
     * @return string
     */
     ...
     *
     * @param Akali\Postgrenerator\Models\Label $placeholder
     *
     * @return string
     */
     ...
     *
     * @return Akali\Postgrenerator\Support\ViewLabelsGenerator
     */
