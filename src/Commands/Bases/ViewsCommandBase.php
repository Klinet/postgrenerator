...
use Akali\Postgrenerator\HtmlGenerators\LaravelCollectiveHtml;
use Akali\Postgrenerator\HtmlGenerators\StandardHtml;
use Akali\Postgrenerator\Models\Resource;
use Akali\Postgrenerator\Models\ViewInput;
use Akali\Postgrenerator\Support\Config;
use Akali\Postgrenerator\Support\Helpers;
use Akali\Postgrenerator\Support\Str;
use Akali\Postgrenerator\Support\ViewLabelsGenerator;
...
abstract class ViewsCommandBase extends Command
{
     ...
     *
     * @param string $stub
     * @param Akali\Postgrenerator\Models\ViewInput $input
     *
     * @return $this
     */
     ...
     * @param string $file
     * @param bool $force
     * @param Akali\Postgrenerator\Models\Resource
     *
     * @return bool
     */
     ...
     * @param string $template
     *
     * @return Akali\Postgrenerator\HtmlGenerators\HtmlGeneratorBase
     */
