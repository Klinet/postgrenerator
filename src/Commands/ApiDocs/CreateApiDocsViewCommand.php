...
namespace Akali\Postgrenerator\Commands\ApiDocs;
...
use Akali\Postgrenerator\Traits\ApiDocViewsTrait;
use Akali\Postgrenerator\Traits\ApiResourceTrait;
...
use Akali\Postgrenerator\Traits\RouteTrait;
...
class CreateApiDocsViewCommand extends Command
{
     ...
     *
     * @param  Akali\Postgrenerator\Model\Label $label
     *
     * @return string
     */
