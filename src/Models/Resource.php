...
use Akali\Postgrenerator\Models\Relation;
...
use Akali\Postgrenerator\Traits\LabelTransformerTrait;
use Exception;
use File;
...
class Resource implements JsonWriter
{
     ...
     *
     * @return min (null | Akali\Postgrenerator\Models\Field)
     */
     ...
     *
     * @return mix (null | Akali\Postgrenerator\Models\Field)
     */
